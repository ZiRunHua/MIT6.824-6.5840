...
- [lab3](#lab3)
  ...
  - [系统设计](#系统设计)
    - [模块划分](#模块划分)
    - [锁顺序](#锁顺序)
  - [Package 设计](#package-设计)
    - [UML](#uml)
    - [Election Package](#election-package)
      - [UML](#uml-1)
      - [成为Leader的条件](#成为leader的条件)
      - [预选举](#预选举)
...
### <a name='ElectionPackage'></a>Election Package
...
### <a name='CommitPackage'></a>Commit Package
...
### <a name='NodePackage'></a>Node Package
